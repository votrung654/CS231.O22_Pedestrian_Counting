...
clf1 = LogisticRegression(C=0.01, max_iter=1000, class_weight='balanced', verbose=1, solver='liblinear')
...
clf2 = LogisticRegression(C=0.01, max_iter=1000, class_weight='balanced', verbose=1, solver='liblinear')
